...
function OnFinish(selProj, selObj)
{
	try
	{
		...
		if (suffix.toLowerCase() != ".cpp" && suffix.toLowerCase() != ".cxx")
...
{
	if (strFileName.toLowerCase() == "sourceFile.cpp".toLowerCase())
	{
...
function GetTargetName(strName, strProjectName, strResPath, strHelpPath)
{
	try
	{
		...
		if (strName.toLowerCase() == "sourceFile.cpp".toLowerCase())
